var nodes = new vis.DataSet([
    { id: 1, label: "Disconnection", explanation: "To actively change conditions (regarding inequality) it is required for an agent to be a 'problem owner' which causes behavioural change. For this to occur, it is required that the agent is connected to the problem. However, there are indications that portions of the population are disconnecte from society causing passive behaviour. Further details about this process can be found in HYPERLINK." },
    { id: 2, label: "Democratic power", explanation: "Democracy is influeneced by inequality, however the exact mechanism is unclear. Two opposing theorems are the 'redistributive perspective' and the 'unequal power perspective' which state that either democratic power resorts to the median voter or by the powerfull few respectively. Further details about their characteristics can be found in HYPERLINK." },
    { id: 3, label: "Unawareness", explanation: "To create an opinion and consequential policy regarding inequality, it is required to be aware of the (current) situation. However, there are multiple indications that information and policies revolving around inequality are either unknown or misinformation has occured. Further details about this process can be found in HYPERLINK." },
    ...
    { id: 7, label: "Measurements", explanation: "To know the present situation and the caused effects of policies it is required to have proper measurements. We find that there are four broad represententation methods revolving around inequality: 1. Lorzen-curve based indices, 2. Generalized entropy based indices, 3. Ratio based indices, and 4. Poverty based indices. Further details about the characteristics of these measurements can be found in HYPERLINK." },
    { id: 8, label: "Economic growth", explanation: "The fortune of society is largely bound by its economic growth, indicating increasing economic opportuinities. It is desired for an economy to have high economic growth to spread improving conditions among its population. Further details about this characteristics can be found in HYPERLINK." },
    ...
    { id: 18, label: "Globalization", explanation: "Due to increased connectivity between countries, economies have become incrreasingly entangled. It has offered opportunity to produce services & goods in country to the country where it will be consumed. This has notably changed operations of (multinational) corporations and their supply in the consumption and job market. Further details about the characteristics of technology can be found in HYPERLINK." },
    ...
    { id: 20, label: "Labour bargaining", explanation: "An important procedure in finding a job and ascerting income and other parameters (such as social security) is mediated by labour bargaining. In this proces the labour market clears supply and demand. Further details about the characteristics of labour market can be found in HYPERLINK." },
