...
var nodes = new vis.DataSet([
    { id: 1,
        label: "Disconnection",
        explanation: "To actively change conditions (regarding inequality) it is required for an agent to be a 'problem owner' which causes behavioural change. For this to occur, it is required that the agent is connected to the problem. However, there are indications that portions of the population are disconnected from society causing passive behaviour. Further details about this process can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 2,
        label: "Democratic power",
        explanation: "Democracy is influenced by inequality, however the exact mechanism is unclear. Two opposing theorems are the 'redistributive perspective' and the 'unequal power perspective' which state that either democratic power resorts to the median voter or by the powerful few respectively. Further details about their characteristics can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 3,
        label: "Unawareness",
        explanation: "To create an opinion and consequential policy regarding inequality, it is required to be aware of the (current) situation. However, there are multiple indications that information and policies revolving around inequality are either unknown or misinformation has occurred. Further details about this process can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 4,
        label: "Stratification",
        explanation: "Within society that are population groups which have their specific characterisations. The characteristics causes that they experience different opportunities and effects from policies but also have different behaviour. Further details about these characteristics can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 5,
        label: "Education",
        explanation: "Education is a pivotal aspect in the development of human capital of an individual and dictates in large portions the opportunities the persons has later in life. When differences occur within the educational system the outcome will experience change. Further details revolving around the educational system can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 6,
        label: "Policy approval",
        explanation: "To cause change, it is required to enforce policies. The process how policies are drafted are of large importance to the opportunities to alter the system. Further details about this process can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 7,
        label: "Measurements",
        explanation: "To know the present situation and the caused effects of policies it is required to have proper measurements. We find that there are four broad representation methods revolving around inequality: 1. Lorenz-curve based indices, 2. Generalized entropy based indices, 3. Ratio based indices, and 4. Poverty based indices. Further details about the characteristics of these measurements can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 8,
        label: "Economic growth",
        explanation: "The fortune of society is largely bound by its economic growth, indicating increasing economic opportunities. It is desired for an economy to have high economic growth to spread improving conditions among its population. Further details about this characteristics can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 9,
        label: "Health",
        explanation: "One of the most important characteristics for individuals to enjoy life is good health. As such, governments have a duty to attempt to provide good health and improve conditions where possible. Further details about this characteristics can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 10,
        label: "Opportunity inequality",
        explanation: "Economic inequality consists out of three branches, one of them being opportunity inequality. This type of inequality considers the opportunity to change socio-economic position (and tightly related income and wealth characteristics). This type of inequality is related the human capital one has and can develop. Further details about the characteristics of opportunity inequality can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 11,
        label: "Wealth transfers",
        explanation: "An important hallmark of wealth is that it can be transferred between individuals. As such, assistance can be given from parent to child, via either in vivo transfers or inheritance, when they are need of financial funds. Further details about the characteristics of these transfers can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 12,
        label: "Mobility",
        explanation: "Mobility assigns the procedure to move up and down the socio-economic ladder. This can be measured from a inter- and intra-generational perspective, and from a relative and a absolute perspective. These differences state whether an individual improves in conditions in absolute terms or relative compared to a point of reference. Further details about the characteristics of mobility can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 13,
        label: "Real estate",
        explanation: "An important asset in the portfolio of citizens is real estate. Either it cause a large portion of their expenses when they are renting or represents the largest portion of their wealth. In either way, it is pivotal in their life and also coordinates inequalities. Further details about the characteristics of real estate can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 14,
        label: "Wealth inequality",
        explanation: "Economic inequality consists out of three branches, one of them being wealth inequality. This type of inequality considers all wealth retained by an individual and is intimately connected to the life-cycle of an individual. Further details about the characteristics of wealth inequality can be found in HYPERLINK.",
        explanationNL: "Nederlandse Uitleg" },
    { id: 15,
...
var edges = new vis.DataSet([
    ...
    { from: 3, to: 21,
        dashes: true,
        explanation: "There are indications that unawareness exists about specific tax & benefit policies. These misinformations causes altered support for these specific tax & benefits, most notoriously the inheritance tax endures large scrutiny. This interaction has not been reviewed in further detail within this thesis." },
    { from: 4, to: 5 },
    { from: 4, to: 9 },
    { from: 4, to: 12 },
    { from: 5, to: 9 },
    ...
    { from: 8, to: 17,
        dashes: true,
        explanation: "There are indications that increased technology increases economic growth by increasing productivity. This interaction has not been reviewed in further detail within this thesis.",
        explanationNL: "Nederlandse Uitleg" },
    { from: 8, to: 25 },
    { from: 9, to: 10 },
    { from: 9, to: 25 },
    ...
    { from: 13, to: 15,
        dashes: true,
        explanation: "There are indications that increased financialization has entered the real estate market causing inflationary effect on housing prices. This interaction has not been reviewed in further detail within this thesis.",
        explanationNL: "Nederlandse Uitleg" },
    { from: 14, to: 15 },
    { from: 14, to: 16 },
    { from: 14, to: 21 },
    ...
    { from: 15, to: 17,
        dashes: true,
        explanation: "There are indications that increased financialization causes reduction in investments and as such reduces technological development. This interaction has not been reviewed in further detail within this thesis.",
        explanationNL: "Nederlandse Uitleg" },
    { from: 16, to: 17 },
    { from: 16, to: 18 },
    { from: 16, to: 19 },
    ...
    { from: 18, to: 22,
        dashes: true,
        explanation: "There are indications that increased globalization enables wealth (and income) to be hiden from tax agents by using tax heavens. This interaction has not been reviewed in further detail within this thesis.",
        explanationNL: "Nederlandse Uitleg" },
    { from: 20, to: 21 },
    { from: 21, to: 22 },
    { from: 21, to: 23 },
