var nodes = new vis.DataSet([
    { id: 1, label: "Disconnection", explanation: "To actively change conditions (regarding inequality) it is required for an agent to be a 'problem owner' which causes behavioural change. For this to occur, it is required that the agent is connected to the problem. However, there are indications that portions of the population are disconnected from society causing passive behaviour. Further details about this process can be found in HYPERLINK.", explanationNL: "nl uitleg", linkToPageGlobal: 38, linkToPageNL: 8 },
...
var edges = new vis.DataSet([
    ...
    { from: 2, to: 6 },
    { from: 3, to: 4 },
    { from: 3, to: 21, dashes: true, explanation: "There are indications that unawareness exists about specific tax & benefit policies. The misinformation causes altered support for these specific tax & benefits, most notoriously the inheritance tax endures large scrutiny. This interaction has not been reviewed in further detail within this thesis." },
    { from: 4, to: 5 },
    { from: 4, to: 9 },
    { from: 4, to: 12 },
    { from: 5, to: 9 , dashes: true, explanation: "INVULLEN" },
    { from: 5, to: 10 },
    { from: 5, to: 12 },
    { from: 5, to: 16 },
    { from: 6, to: 7 },
    ...
    { from: 9, to: 25 },
    { from: 10, to: 11 },
    { from: 10, to: 25 , dashes: true, explanation: "INVULLEN" },
    { from: 11, to: 14 },
    { from: 11, to: 12 },
    { from: 11, to: 13, dashes: true, explanation: "There are indications that wealth transfer can aid in the purchase of housing. For example, within the Netherlands there is dedicated wealth transfer policy. This interaction has not been reviewed in further detail within this thesis." },
    { from: 11, to: 21, explanation: "NEW? DASHES OR NOT??" },
    { from: 12, to: 13 },
    { from: 12, to: 16 },
    { from: 13, to: 14 },
    ...
    { from: 16, to: 21 },
    { from: 16, to: 25 },
    { from: 18, to: 22, dashes: true, explanation: "There are indications that increased globalization enables wealth (and income) to be hidden from tax agents by using tax heavens. This interaction has not been reviewed in further detail within this thesis." },
    { from: 20, to: 21 },
    { from: 21, to: 22 },
    { from: 21, to: 23 },
    { from: 22, to: 24 },
