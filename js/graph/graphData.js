...
linkToPageGlobal: 25},
    { id: 4, label: "Stratification", explanation: "Within society, there are population groups which have their specific characterisations. The characteristics cause that they experience different opportunities and effects from policies but also have different behaviour. Further details about these characteristics can be found in HYPERLINK.",
linkToPageGlobal: 35},
    { id: 5, label: "Education", explanation: "Education is a pivotal aspect in the development of human capital of an individual and dictates in large portions the opportunities an individual experiences later in life. When differences occur within the educational system the outcome will experience change. Further details revolving around the educational system can be found in HYPERLINK.",
linkToPageGlobal: 30},
    { id: 6, label: "Policy Approval", explanation: "To cause change, it is required to enforce policies. The process of how policies are drafted is of large importance to the opportunities to alter the system. Further details about this process can be found in HYPERLINK.",
linkToPageGlobal: 23},
...
linkToPageGlobal: 55},
    { id: 8, label: "Economic Growth", explanation: "The fortune of society is largely bound by its economic growth, indicating increasing economic opportunities. It is desired for an economy to have high economic growth to spread improving conditions among its population. Further details about this characteristic can be found in HYPERLINK.",
linkToPageGlobal: 38},
    { id: 9, label: "Health", explanation: "One of the most important characteristics for individuals to enjoy life is good health. As such, governments have a duty to attempt to provide good health and improve conditions where possible. Further details about this characteristic can be found in HYPERLINK.",
linkToPageGlobal: 18},
    { id: 10, label: "Opportunity Inequality", explanation: "Economic inequality consists out of three branches, one of them being opportunity inequality. This type of inequality considers the opportunity to change socio-economic position (and tightly related income and wealth characteristics). This type of inequality is related to the human capital one has and can develop. Further details about the characteristics of opportunity inequality can be found in HYPERLINK.",
linkToPageGlobal: 98},
    { id: 11, label: "Wealth Transfers", explanation: "An important hallmark of wealth is that it can be transferred between individuals. As such, assistance can be given from parent to child, via either in vivo transfers or inheritance, when they require financial funds. Further details about the characteristics of these transfers can be found in HYPERLINK.",
linkToPageGlobal: 94},
    { id: 12, label: "Mobility", explanation: "Mobility assigns the procedure to move up and down the socio-economic ladder. This can be measured from an inter- and intra-generational perspective, and a relative and an absolute perspective. These differences state whether an individual improves in conditions in absolute terms or relative compared to a point of reference. Further details about the characteristics of mobility can be found in HYPERLINK.",
linkToPageGlobal: 99},
    { id: 13, label: "Real Estate", explanation: "An important asset in the portfolio of citizens is real estate. It either is a large portion of their expenses when they are renting or it represents the largest portion of their wealth owned. Either way, it is pivotal in their life and also coordinates inequalities. Further details about the characteristics of real estate can be found in HYPERLINK.",
linkToPageGlobal: 98},
...
linkToPageGlobal: 74},
    { id: 17, label: "Technology", explanation: "Technological changes are an important driver in driving productivity upwards. While doing so, it creates new job opportunities but also causes other jobs to become redundant influencing the jobs market. Moreover, for technological change, R&D investments are required to invent new opportunities. Further details about the characteristics of technology can be found in HYPERLINK.",
linkToPageGlobal: 79},
